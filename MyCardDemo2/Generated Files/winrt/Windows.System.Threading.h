...
namespace winrt::impl
{
    ...
    {
        void* operation{};
        check_hresult(WINRT_SHIM(Windows::System::Threading::IThreadPoolStatics)->RunAsync(*(void**)(&handler), &operation));
    ...
    {
        void* operation{};
        check_hresult(WINRT_SHIM(Windows::System::Threading::IThreadPoolStatics)->RunWithPriorityAsync(*(void**)(&handler), static_cast<int32_t>(priority), &operation));
        return { operation, take_ownership_from_abi };
    }
    ...
    {
        void* operation{};
        check_hresult(WINRT_SHIM(Windows::System::Threading::IThreadPoolStatics)->RunWithPriorityAndOptionsAsync(*(void**)(&handler), static_cast<int32_t>(priority), static_cast<uint32_t>(options), &operation));
        return { operation, take_ownership_from_abi };
    }
    ...
    {
        void* timer{};
        check_hresult(WINRT_SHIM(Windows::System::Threading::IThreadPoolTimerStatics)->CreatePeriodicTimer(*(void**)(&handler), impl::bind_in(period), &timer));
    ...
    {
        void* timer{};
        check_hresult(WINRT_SHIM(Windows::System::Threading::IThreadPoolTimerStatics)->CreateTimer(*(void**)(&handler), impl::bind_in(delay), &timer));
        return { timer, take_ownership_from_abi };
    }
    ...
    {
        void* timer{};
        check_hresult(WINRT_SHIM(Windows::System::Threading::IThreadPoolTimerStatics)->CreatePeriodicTimerWithCompletion(*(void**)(&handler), impl::bind_in(period), *(void**)(&destroyed), &timer));
        return { timer, take_ownership_from_abi };
    }
    ...
    {
        void* timer{};
        check_hresult(WINRT_SHIM(Windows::System::Threading::IThreadPoolTimerStatics)->CreateTimerWithCompletion(*(void**)(&handler), impl::bind_in(delay), *(void**)(&destroyed), &timer));
        return { timer, take_ownership_from_abi };
    }
    template <typename H> struct delegate<Windows::System::Threading::TimerDestroyedHandler, H> : implements_delegate<Windows::System::Threading::TimerDestroyedHandler, H>
    {
        ...
        int32_t WINRT_CALL Invoke(void* timer) noexcept final try
        {
