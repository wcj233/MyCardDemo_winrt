...
namespace winrt::impl
{
    ...
    {
        check_hresult(WINRT_SHIM(Windows::Devices::Gpio::IGpioChangeCounter)->put_Polarity(static_cast<int32_t>(value)));
    }
    ...
    {
        void* value{};
        check_hresult(WINRT_SHIM(Windows::Devices::Gpio::IGpioChangeCounterFactory)->Create(*(void**)(&pin), &value));
    ...
    {
        check_hresult(WINRT_SHIM(Windows::Devices::Gpio::IGpioChangeReader)->put_Polarity(static_cast<int32_t>(value)));
    }
    ...
    {
        void* value{};
        check_hresult(WINRT_SHIM(Windows::Devices::Gpio::IGpioChangeReaderFactory)->Create(*(void**)(&pin), &value));
        return { value, take_ownership_from_abi };
    }
    ...
    {
        void* value{};
        check_hresult(WINRT_SHIM(Windows::Devices::Gpio::IGpioChangeReaderFactory)->CreateWithCapacity(*(void**)(&pin), minCapacity, &value));
        return { value, take_ownership_from_abi };
    }
    ...
    {
        void* pin{};
        check_hresult(WINRT_SHIM(Windows::Devices::Gpio::IGpioController)->OpenPinWithSharingMode(pinNumber, static_cast<int32_t>(sharingMode), &pin));
        return { pin, take_ownership_from_abi };
    }
    ...
    {
        bool succeeded;
        check_hresult(WINRT_SHIM(Windows::Devices::Gpio::IGpioController)->TryOpenPin(pinNumber, static_cast<int32_t>(sharingMode), impl::bind_out(pin), impl::bind_out(openStatus), &succeeded));
        return succeeded;
    }
    ...
    {
        void* operation{};
        check_hresult(WINRT_SHIM(Windows::Devices::Gpio::IGpioControllerStatics2)->GetControllersAsync(*(void**)(&provider), &operation));
        return { operation, take_ownership_from_abi };
    }
    ...
    template <typename D> winrt::event_token consume_Windows_Devices_Gpio_IGpioPin<D>::ValueChanged(Windows::Foundation::TypedEventHandler<Windows::Devices::Gpio::GpioPin, Windows::Devices::Gpio::GpioPinValueChangedEventArgs> const& handler) const
    {
        ...
        check_hresult(WINRT_SHIM(Windows::Devices::Gpio::IGpioPin)->add_ValueChanged(*(void**)(&handler), put_abi(token)));
        return token;
    }
    ...
    {
        WINRT_VERIFY_(0, WINRT_SHIM(Windows::Devices::Gpio::IGpioPin)->remove_ValueChanged(impl::bind_in(token)));
    }
    ...
    {
        check_hresult(WINRT_SHIM(Windows::Devices::Gpio::IGpioPin)->put_DebounceTimeout(impl::bind_in(value)));
    }
    ...
    {
        bool supported;
        check_hresult(WINRT_SHIM(Windows::Devices::Gpio::IGpioPin)->IsDriveModeSupported(static_cast<int32_t>(driveMode), &supported));
        return supported;
    }
    ...
    {
        check_hresult(WINRT_SHIM(Windows::Devices::Gpio::IGpioPin)->SetDriveMode(static_cast<int32_t>(value)));
    }
    ...
    {
        check_hresult(WINRT_SHIM(Windows::Devices::Gpio::IGpioPin)->Write(static_cast<int32_t>(value)));
    }
