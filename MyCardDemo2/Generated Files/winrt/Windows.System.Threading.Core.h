...
namespace winrt::impl
{
    ...
    {
        void* workItem{};
        check_hresult(WINRT_SHIM(Windows::System::Threading::Core::IPreallocatedWorkItemFactory)->CreateWorkItem(*(void**)(&handler), &workItem));
    ...
    {
        void* WorkItem{};
        check_hresult(WINRT_SHIM(Windows::System::Threading::Core::IPreallocatedWorkItemFactory)->CreateWorkItemWithPriority(*(void**)(&handler), static_cast<int32_t>(priority), &WorkItem));
        return { WorkItem, take_ownership_from_abi };
    }
    ...
    {
        void* WorkItem{};
        check_hresult(WINRT_SHIM(Windows::System::Threading::Core::IPreallocatedWorkItemFactory)->CreateWorkItemWithPriorityAndOptions(*(void**)(&handler), static_cast<int32_t>(priority), static_cast<uint32_t>(options), &WorkItem));
        return { WorkItem, take_ownership_from_abi };
    }
    ...
    {
        void* signalNotifier{};
        check_hresult(WINRT_SHIM(Windows::System::Threading::Core::ISignalNotifierStatics)->AttachToEvent(*(void**)(&name), *(void**)(&handler), &signalNotifier));
    ...
    {
        void* signalNotifier{};
        check_hresult(WINRT_SHIM(Windows::System::Threading::Core::ISignalNotifierStatics)->AttachToEventWithTimeout(*(void**)(&name), *(void**)(&handler), impl::bind_in(timeout), &signalNotifier));
        return { signalNotifier, take_ownership_from_abi };
    }
    ...
    {
        void* signalNotifier{};
        check_hresult(WINRT_SHIM(Windows::System::Threading::Core::ISignalNotifierStatics)->AttachToSemaphore(*(void**)(&name), *(void**)(&handler), &signalNotifier));
        return { signalNotifier, take_ownership_from_abi };
    }
    ...
    {
        void* signalNotifier{};
        check_hresult(WINRT_SHIM(Windows::System::Threading::Core::ISignalNotifierStatics)->AttachToSemaphoreWithTimeout(*(void**)(&name), *(void**)(&handler), impl::bind_in(timeout), &signalNotifier));
        return { signalNotifier, take_ownership_from_abi };
    }
    template <typename H> struct delegate<Windows::System::Threading::Core::SignalHandler, H> : implements_delegate<Windows::System::Threading::Core::SignalHandler, H>
    {
        ...
        int32_t WINRT_CALL Invoke(void* signalNotifier, bool timedOut) noexcept final try
        {
