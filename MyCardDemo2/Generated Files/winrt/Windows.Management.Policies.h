...
namespace winrt::impl
{
    ...
    template <typename D> winrt::event_token consume_Windows_Management_Policies_INamedPolicyData<D>::Changed(Windows::Foundation::TypedEventHandler<Windows::Management::Policies::NamedPolicyData, Windows::Foundation::IInspectable> const& changedHandler) const
    {
        ...
        check_hresult(WINRT_SHIM(Windows::Management::Policies::INamedPolicyData)->add_Changed(*(void**)(&changedHandler), put_abi(cookie)));
        return cookie;
    }
    ...
    {
        WINRT_VERIFY_(0, WINRT_SHIM(Windows::Management::Policies::INamedPolicyData)->remove_Changed(impl::bind_in(cookie)));
    }
    ...
    {
        void* result{};
        check_hresult(WINRT_SHIM(Windows::Management::Policies::INamedPolicyStatics)->GetPolicyFromPath(*(void**)(&area), *(void**)(&name), &result));
        return { result, take_ownership_from_abi };
    }
    ...
    {
        void* result{};
        check_hresult(WINRT_SHIM(Windows::Management::Policies::INamedPolicyStatics)->GetPolicyFromPathForUser(*(void**)(&user), *(void**)(&area), *(void**)(&name), &result));
        return { result, take_ownership_from_abi };
    }
    template <typename D>
