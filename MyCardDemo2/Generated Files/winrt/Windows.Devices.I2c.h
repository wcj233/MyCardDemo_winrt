...
namespace winrt::impl
{
    ...
    {
        check_hresult(WINRT_SHIM(Windows::Devices::I2c::II2cConnectionSettings)->put_BusSpeed(static_cast<int32_t>(value)));
    }
    ...
    {
        check_hresult(WINRT_SHIM(Windows::Devices::I2c::II2cConnectionSettings)->put_SharingMode(static_cast<int32_t>(value)));
    }
    ...
    {
        void* device{};
        check_hresult(WINRT_SHIM(Windows::Devices::I2c::II2cController)->GetDevice(*(void**)(&settings), &device));
    ...
    {
        void* operation{};
        check_hresult(WINRT_SHIM(Windows::Devices::I2c::II2cControllerStatics)->GetControllersAsync(*(void**)(&provider), &operation));
    ...
    {
        void* value{};
        check_hresult(WINRT_SHIM(Windows::Devices::I2c::II2cDeviceStatics)->GetDeviceSelectorFromFriendlyName(*(void**)(&friendlyName), &value));
        return { value, take_ownership_from_abi };
    }
    ...
    {
        void* operation{};
        check_hresult(WINRT_SHIM(Windows::Devices::I2c::II2cDeviceStatics)->FromIdAsync(*(void**)(&deviceId), *(void**)(&settings), &operation));
        return { operation, take_ownership_from_abi };
    }
    template <typename D>
