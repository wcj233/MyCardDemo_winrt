...
namespace winrt::impl
{
    ...
    {
        check_hresult(WINRT_SHIM(Windows::UI::WindowManagement::Preview::IWindowManagementPreviewStatics)->SetPreferredMinSize(*(void**)(&window), impl::bind_in(preferredFrameMinSize)));
    }
    template <typename D>
