...
namespace winrt::impl
{
    ...
    {
        V winrt_impl_result{ empty_value<V>() };
        check_hresult(WINRT_SHIM(Windows::Foundation::Collections::IMapView<K, V>)->Lookup(impl::bind_in(key), put_abi(winrt_impl_result)));
        return winrt_impl_result;
    }
    ...
    {
        bool winrt_impl_result;
        check_hresult(WINRT_SHIM(Windows::Foundation::Collections::IMapView<K, V>)->HasKey(impl::bind_in(key), &winrt_impl_result));
        return winrt_impl_result;
    }
    ...
    {
        check_hresult(WINRT_SHIM(Windows::Foundation::Collections::IMapView<K, V>)->Split(impl::bind_out(first), impl::bind_out(second)));
    }
    ...
    {
        V winrt_impl_result{ empty_value<V>() };
        check_hresult(WINRT_SHIM(Windows::Foundation::Collections::IMap<K, V>)->Lookup(impl::bind_in(key), put_abi(winrt_impl_result)));
        return winrt_impl_result;
    }
    ...
    {
        bool winrt_impl_result;
        check_hresult(WINRT_SHIM(Windows::Foundation::Collections::IMap<K, V>)->HasKey(impl::bind_in(key), &winrt_impl_result));
        return winrt_impl_result;
    }
    ...
    {
        bool winrt_impl_result;
        check_hresult(WINRT_SHIM(Windows::Foundation::Collections::IMap<K, V>)->Insert(impl::bind_in(key), impl::bind_in(value), &winrt_impl_result));
        return winrt_impl_result;
    }
    ...
    {
        check_hresult(WINRT_SHIM(Windows::Foundation::Collections::IMap<K, V>)->Remove(impl::bind_in(key)));
    }
    ...
    template <typename D, typename K, typename V> winrt::event_token consume_Windows_Foundation_Collections_IObservableMap<D, K, V>::MapChanged(Windows::Foundation::Collections::MapChangedEventHandler<K, V> const& vhnd) const
    {
        ...
        check_hresult(WINRT_SHIM(Windows::Foundation::Collections::IObservableMap<K, V>)->add_MapChanged(*(void**)(&vhnd), put_abi(winrt_impl_result)));
        return winrt_impl_result;
    }
    ...
    {
        WINRT_VERIFY_(0, WINRT_SHIM(Windows::Foundation::Collections::IObservableMap<K, V>)->remove_MapChanged(impl::bind_in(token)));
    }
    ...
    {
        winrt::event_token winrt_impl_result;
        check_hresult(WINRT_SHIM(Windows::Foundation::Collections::IObservableVector<T>)->add_VectorChanged(*(void**)(&vhnd), put_abi(winrt_impl_result)));
        return winrt_impl_result;
    }
    ...
    {
        WINRT_VERIFY_(0, WINRT_SHIM(Windows::Foundation::Collections::IObservableVector<T>)->remove_VectorChanged(impl::bind_in(token)));
    }
    ...
    {
        bool winrt_impl_result;
        check_hresult(WINRT_SHIM(Windows::Foundation::Collections::IVectorView<T>)->IndexOf(impl::bind_in(value), &index, &winrt_impl_result));
        return winrt_impl_result;
    }
    ...
    {
        bool winrt_impl_result;
        check_hresult(WINRT_SHIM(Windows::Foundation::Collections::IVector<T>)->IndexOf(impl::bind_in(value), &index, &winrt_impl_result));
        return winrt_impl_result;
    }
    ...
    {
        check_hresult(WINRT_SHIM(Windows::Foundation::Collections::IVector<T>)->SetAt(index, impl::bind_in(value)));
    }
    ...
    {
        check_hresult(WINRT_SHIM(Windows::Foundation::Collections::IVector<T>)->InsertAt(index, impl::bind_in(value)));
    }
    ...
    {
        check_hresult(WINRT_SHIM(Windows::Foundation::Collections::IVector<T>)->Append(impl::bind_in(value)));
    }
    ...
    template <typename H, typename K, typename V> struct delegate<Windows::Foundation::Collections::MapChangedEventHandler<K, V>, H> : implements_delegate<Windows::Foundation::Collections::MapChangedEventHandler<K, V>, H>
    {
        ...
        int32_t WINRT_CALL Invoke(void* sender, void* event) noexcept final try
        {
