...
namespace winrt::impl
{
    ...
    {
        check_hresult(WINRT_SHIM(Windows::Devices::Spi::ISpiConnectionSettings)->put_Mode(static_cast<int32_t>(value)));
    }
    ...
    {
        check_hresult(WINRT_SHIM(Windows::Devices::Spi::ISpiConnectionSettings)->put_SharingMode(static_cast<int32_t>(value)));
    }
    ...
    {
        void* device{};
        check_hresult(WINRT_SHIM(Windows::Devices::Spi::ISpiController)->GetDevice(*(void**)(&settings), &device));
    ...
    {
        void* operation{};
        check_hresult(WINRT_SHIM(Windows::Devices::Spi::ISpiControllerStatics)->GetControllersAsync(*(void**)(&provider), &operation));
        return { operation, take_ownership_from_abi };
    }
    ...
    {
        void* value{};
        check_hresult(WINRT_SHIM(Windows::Devices::Spi::ISpiDeviceStatics)->GetDeviceSelectorFromFriendlyName(*(void**)(&friendlyName), &value));
        return { value, take_ownership_from_abi };
    }
    ...
    {
        void* busInfo{};
        check_hresult(WINRT_SHIM(Windows::Devices::Spi::ISpiDeviceStatics)->GetBusInfo(*(void**)(&busId), &busInfo));
    ...
    {
        void* operation{};
        check_hresult(WINRT_SHIM(Windows::Devices::Spi::ISpiDeviceStatics)->FromIdAsync(*(void**)(&busId), *(void**)(&settings), &operation));
        return { operation, take_ownership_from_abi };
    }
    template <typename D>
