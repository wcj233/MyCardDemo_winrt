...
namespace winrt::impl
{
    ...
    {
        void* result{};
        check_hresult(WINRT_SHIM(Windows::Perception::People::IHandMeshObserver)->GetVertexStateForPose(*(void**)(&handPose), &result));
    ...
    {
        bool result;
        check_hresult(WINRT_SHIM(Windows::Perception::People::IHandPose)->TryGetJoint(*(void**)(&coordinateSystem), static_cast<int32_t>(joint), impl::bind_out(jointPose), &result));
        return result;
    }
    ...
    {
        bool result;
        check_hresult(WINRT_SHIM(Windows::Perception::People::IHandPose)->TryGetJoints(*(void**)(&coordinateSystem), joints.size(), get_abi(joints), jointPoses.size(), put_abi(jointPoses), &result));
        return result;
    }
    template <typename D> Windows::Perception::People::JointPose consume_Windows_Perception_People_IHandPose<D>::GetRelativeJoint(Windows::Perception::People::HandJointKind const& joint, Windows::Perception::People::HandJointKind const& referenceJoint) const
    {
        ...
        check_hresult(WINRT_SHIM(Windows::Perception::People::IHandPose)->GetRelativeJoint(static_cast<int32_t>(joint), static_cast<int32_t>(referenceJoint), put_abi(result)));
        return result;
    }
