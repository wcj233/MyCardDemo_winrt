...
namespace winrt::impl
{
    ...
    {
        void* result{};
        check_hresult(WINRT_SHIM(Windows::Globalization::Collation::ICharacterGroupings)->Lookup(*(void**)(&text), &result));
    ...
    {
        void* result{};
        check_hresult(WINRT_SHIM(Windows::Globalization::Collation::ICharacterGroupingsFactory)->Create(*(void**)(&language), &result));
        return { result, take_ownership_from_abi };
    }
    template <typename D>
