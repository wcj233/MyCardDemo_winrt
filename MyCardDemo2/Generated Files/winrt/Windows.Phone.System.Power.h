...
namespace winrt::impl
{
    ...
    template <typename D> winrt::event_token consume_Windows_Phone_System_Power_IPowerManagerStatics<D>::PowerSavingModeChanged(Windows::Foundation::EventHandler<Windows::Foundation::IInspectable> const& changeHandler) const
    {
        ...
        check_hresult(WINRT_SHIM(Windows::Phone::System::Power::IPowerManagerStatics)->add_PowerSavingModeChanged(*(void**)(&changeHandler), put_abi(token)));
        return token;
    }
    ...
    {
        WINRT_VERIFY_(0, WINRT_SHIM(Windows::Phone::System::Power::IPowerManagerStatics)->remove_PowerSavingModeChanged(impl::bind_in(token)));
    }
