...
namespace winrt::MyCardDemo2::implementation
{
    ...
    struct WINRT_EBO SingleCardUserControl_base : implements<D, MyCardDemo2::SingleCardUserControl, composing, Windows::UI::Xaml::Controls::IControlOverrides, Windows::UI::Xaml::Controls::IControlOverrides6, Windows::UI::Xaml::IFrameworkElementOverrides, Windows::UI::Xaml::IFrameworkElementOverrides2, Windows::UI::Xaml::IUIElementOverrides, Windows::UI::Xaml::IUIElementOverrides7, Windows::UI::Xaml::IUIElementOverrides8, Windows::UI::Xaml::IUIElementOverrides9, I...>,
    ...
    {
        using base_type = SingleCardUserControl_base;
        using class_type = MyCardDemo2::SingleCardUserControl;
        using implements_type = typename SingleCardUserControl_base::implements_type;
        using implements_type::implements_type;
        using composable_base = Windows::UI::Xaml::Controls::UserControl;
        hstring GetRuntimeClassName() const
        {
            return L"MyCardDemo2.SingleCardUserControl";
        }
        SingleCardUserControl_base()
        {
...
namespace winrt::MyCardDemo2::factory_implementation
{
    ...
    struct WINRT_EBO SingleCardUserControlT : implements<D, Windows::Foundation::IActivationFactory, I...>
    {
        using instance_type = MyCardDemo2::SingleCardUserControl;
...
#if defined(WINRT_FORCE_INCLUDE_SINGLECARDUSERCONTROL_XAML_G_H) || __has_include("SingleCardUserControl.xaml.g.h")
#include "SingleCardUserControl.xaml.g.h"
#else

namespace winrt::MyCardDemo2::implementation
{
    template <typename D, typename... I>
    using SingleCardUserControlT = SingleCardUserControl_base<D, I...>;
}
